...
import { defaultOrderByFn, useTable, useFilters, useColumnOrder, useGroupBy, useSortBy, useExpanded, useRowSelect, useResizeColumns } from 'react-table';
...
import { CLEAR_SORTING, SORT_ASCENDING, SORT_DESCENDING, GROUP, UNGROUP } from '@ui5/webcomponents-react/dist/assets/i18n/i18n-defaults';
...
var ColumnHeaderModal = /*#__PURE__*/forwardRef(function (props, ref) {
  ...
  var _useI18nText = useI18nText('@ui5/webcomponents-react', CLEAR_SORTING, SORT_ASCENDING, SORT_DESCENDING, GROUP, UNGROUP),
  ...
  return /*#__PURE__*/createPortal( /*#__PURE__*/React.createElement(Popover, {
    ...
    icon: "decline",
    "data-sort": "clear"
  }, clearSortingText), showFilter && !column.isGrouped && /*#__PURE__*/React.createElement(FlexBox, {
...
var ColumnHeader = function ColumnHeader(props) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    name: "group-2"
  }))), hasPopover && /*#__PURE__*/React.createElement(ColumnHeaderModal, {
    column: column,
    onSort: onSort,
    onGroupBy: onGroupBy,
    ref: popoverRef
...
var useStyles$1 = createUseStyles(styles$2);
var ColumnHeaderContainer = function ColumnHeaderContainer(props) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, headerProps, {
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, column.canResize && column.getResizerProps && /*#__PURE__*/React.createElement("div", _extends({}, column.getResizerProps(), {
      "data-resizer": true,
      className: classes.resizer,
      style: {
        left: "".concat(column.totalFlexWidth + column.totalLeft - (isLastColumn ? 3 : 0), "px")
      }
    })), /*#__PURE__*/React.createElement(ColumnHeader, _extends({}, column.getHeaderProps(), {
      onSort: onSort,
...
var DefaultLoadingComponent = function DefaultLoadingComponent(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Loader, {
    delay: 500,
    style: _objectSpread(_objectSpread({}, styles$3), style)
  });
};
...
var VirtualTableBody = function VirtualTableBody(props) {
  ...
  var consolidatedParentRef = useConsolidatedRef(parentRef);
...
var VirtualTableBodyContainer = function VirtualTableBodyContainer(props) {
  ...
  var classNames = StyleClassHelper.of(classes.tbody, GlobalStyleClasses.sapScrollBar).className;
...
var useStyles$2 = createComponentStyles(styles, {
...
var AnalyticalTable = /*#__PURE__*/forwardRef(function (props, ref) {
  ...
  }, reactTableOptions), useFilters, useColumnOrder, useGroupBy, useSortBy, useExpanded, useRowSelect, useResizeColumns, useRowSelectionColumn, useSingleRowStateSelection, useRowHighlight, useDynamicColumnWidths, useStyling, useToggleRowExpand, useVisibleColumnsWidth].concat(_toConsumableArray(tableHooks))),
