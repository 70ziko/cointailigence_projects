 ...
 */
var MultiComboBox = withWebComponent('ui5-multi-combobox', ['placeholder', 'value', 'valueState'], ['allowCustomValues', 'disabled', 'open', 'readonly', 'required'], [], ['change', 'input', 'open-change', 'selection-change']);
