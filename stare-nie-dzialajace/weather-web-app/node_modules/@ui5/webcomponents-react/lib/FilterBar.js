...
import { BASIC, CANCEL, CLEAR, RESTORE, SAVE, SEARCH_FOR_FILTERS, SHOW_ON_FILTER_BAR, SHOW_FILTER_BAR, HIDE_FILTER_BAR, GO, FILTERS } from '@ui5/webcomponents-react/dist/assets/i18n/i18n-defaults';
...
var FilterDialog = function FilterDialog(props) {
  ...
  var _useI18nText = useI18nText('@ui5/webcomponents-react', BASIC, CANCEL, CLEAR, RESTORE, SAVE, SEARCH_FOR_FILTERS, SHOW_ON_FILTER_BAR),
  ...
  var footerContentRight = useMemo(function () {
    ...
    }, "Go"), showClearButton && /*#__PURE__*/React.createElement(Button, {
  ...
  var renderHeader = useCallback(function () {
    return /*#__PURE__*/React.createElement(FlexBox, {
      ...
      level: TitleLevel.H4
    }, "Filters"), showSearch && /*#__PURE__*/React.createElement(Input, {
...
var FilterBar = /*#__PURE__*/forwardRef(function (props, ref) {
  ...
  var _useI18nText = useI18nText('@ui5/webcomponents-react', CLEAR, RESTORE, SHOW_FILTER_BAR, HIDE_FILTER_BAR, GO, FILTERS),
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, dialogOpen && showFilterConfiguration && /*#__PURE__*/React.createElement(FilterDialog, {
    ...
    ref: searchRef
  }, renderSearchWithValue(search, searchValue)), /*#__PURE__*/React.createElement(ToolbarSpacer, null), useToolbar && showClearOnFB && /*#__PURE__*/React.createElement(Button, {
    onClick: onClear,
    design: ButtonDesign.Transparent
