...
const block3 = (context) => { return html`<span id="${ifDefined(context._id)}-exceededText" class="ui5-textarea-exceeded-text">${ifDefined(context._exceededTextProps.exceededText)}</span>`; };
