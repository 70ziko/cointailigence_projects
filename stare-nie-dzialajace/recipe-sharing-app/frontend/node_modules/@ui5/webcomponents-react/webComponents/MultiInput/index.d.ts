...
export interface MultiInputPropTypes extends Omit<WithWebComponentPropTypes, 'onChange' | 'onInput' | 'onSubmit'> {
     ...
     */
    onTokenDelete?: (event: CustomEvent<{
        token: ReactNode;
    }>) => void;
    /**
     ...
     */
    onSuggestionItemPreview?: (event: CustomEvent<{
        item: ReactNode;
        targetRef: ReactNode;
    }>) => void;
    /**
     ...
     */
    onSuggestionItemSelect?: (event: CustomEvent<{
        item: ReactNode;
    }>) => void;
    /**
     * Fired when the user scrolls the suggestion popover.
     */
    onSuggestionScroll?: (event: CustomEvent<{
        scrollTop: number;
 ...
 */
declare const MultiInput: FC<MultiInputPropTypes>;
export { MultiInput };
